...
import csv
# from tqdm.notebook import trange, tqdm        # - Uncomment pentru un rezultat mai estetic (afiseaza mult mai frumos intr-un notebook decat in .py)
...
advanced_network.classifier = nn.Linear(in_features=last_good_dense_layer, out_features=3).cuda()
